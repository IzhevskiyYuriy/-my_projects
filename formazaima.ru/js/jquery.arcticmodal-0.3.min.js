            ...
            show: function() {
                ...
                if (!1 === a) d.error("jquery.arcticmodal: Uncorrect call");
                    ...
                    if ("hidden" != b.wrap.css("overflow")) {
                        ...
                        g !=
                            c && b.wrap.css("marginRight", g - c + "px") && $('.header').css("marginRight", g - c + "px") && $('.order').css("marginRight", g - c + "px");
                    }
                ...
                if (d.isFunction(this)) e.each(function() {
                    ...
                    if (!1 === a) d.error("jquery.arcticmodal: Uncorrect call");
                        ...
                        !1 !== b.beforeClose(b, a) && (a.trigger("beforeClose"), e.not(a).last().each(function() {
                            ...
                            a.data("arcticmodal",
                                null);
                            d(".arcticmodal-container").length || (b.wrap.data("arcticmodalOverflow") && b.wrap.css("overflow", b.wrap.data("arcticmodalOverflow")), b.wrap.css("marginRight", 0), $('.header').css("marginRight", 0), $('.order').css("marginRight", 0))
